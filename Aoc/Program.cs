...
internal static class Aoc
{
    ...
    {
        // Needs to be set correctly for each version of advent of code
        const string aocPath = @"c:\Projects\AdventOfCode\Advent-Of-Code-2015";
        ...
        foreach (var assemblyName in Enumerable.Range(1, 25).ToString("Day00"))
        {
            ...
            var current = (int)main?.Invoke(null, [new[]{$"{aocPath}/{assemblyName}/input.txt"}])!;
